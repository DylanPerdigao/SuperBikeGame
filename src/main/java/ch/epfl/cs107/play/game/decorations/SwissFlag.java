...
public class SwissFlag extends GameEntity implements Actor{
	private ImageGraphics baliseGraphics;
	
	public SwissFlag(ActorGame game, boolean fixed, Vector position) {
		super(game, false, position);
		baliseGraphics = new ImageGraphics("swiss.flag.png", 1, 2, position);
